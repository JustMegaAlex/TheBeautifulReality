...
dialog_tree = {
    ...
    options: {
        "Hey Sharon, how was your day?": "Oh Robin, I had the most delightful time with the kids!" +
            "\nAnd the house is sparkling clean of course…thanks to my trusty hard work." +
            "\nYou’re such a lucky man to have me, you know.",

        "Have you been taking some time for yourself?": "What a considerate, handsomely tall and caring husband I have." +
