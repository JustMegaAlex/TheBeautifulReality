...
DebugDrawVar("inv layer", layer_exists("Inventory"))
DebugDrawVar("inv", instance_exists(oInventory))
DebugDrawVar("inv.x", oInventory.x)
DebugDrawVar("inv.y", oInventory.y)
